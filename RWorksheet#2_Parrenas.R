...
#8 the 25 most powerful celebrities and their annual pay as ranked by the editions of Forbes magazine and as listed on the Forbes.com website.
  ...
  #8b Modify the power ranking and pay of J.K. Rowling. Change power ranking to 15 and pay to 90
    celebrity_Data$power_ranking[celebrity_Data$celebrity_Name == "J.K Rowling"] <- 15
    celebrity_Data$annual_pay[celebrity_Data$celebrity_Name == "J.K Rowling"] <- 90
    celebrity_Data
    
  #8c Save as a CSV file
...
#9 Download the Hotels-Vienna https://tinyurl.com/Hotels-Vienna
  #9a Import the excel file into your RStudio.
  ...
  #9e Display the first six rows and last six rows of the new.RData. What is the R script?
...
#10 list of ten (10) vegetables you ate during your lifetime
  veggieList <- c("squash","egg plant","carrot","cabbage","potatoe","broccoli","lettuce","cucumber","corn","celery" )
  veggieList
  
  #10b Add 2 additional vegetables after the last vegetables in the list.
  veggieList <-append(veggieList, c("pepper","spinach"))
  veggieList
  
  #10c Add 4 additional vegetables after index 5. How many data points does your vegetable list have?
  veggieList <- append(veggieList, c("mushroom", "asparagus", "radish", "cauliflower"), after = 5)
  veggieList
  ...
  veggieList <- veggieList[-indices_to_remove]
  veggieList
